...
def evaluate_coco_script(project_name='coco', compound_coef=0, weights_path=None, nms_threshold=0.5, use_cuda=True, gpu=0, use_float16=False, override_prev_results=True, epoch=0):
